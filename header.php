...
<head>
    ...
    <meta name="keywords" content="<?php $this->options->title(); ?> - <?php $this->options->desc(); ?>">
    <title><?php $this->archiveTitle(array(
            'category'  =>  _t('分类 %s 下的文章'),
            'search'    =>  _t('包含关键字 %s 的文章'),
            'tag'       =>  _t('标签 %s 下的文章'),
            'author'    =>  _t('%s 发布的文章')
        ), '', ' - '); ?><?php $this->options->title(); ?> - <?php $this->options->desc(); ?></title>
    <!-- 使用url函数转换相关路径 -->
...
<div id="headnav" class="headnav">
    <div class="inheadnav">
        <div id="headlogo" class="headlogo"><a class="navmla2 nav_menu_li_a2" style="padding: 0;" href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a></div>
        <ul class="nav_menu">
...
<div id="m_nav">
    <div class="m_innav">
        ...
        <div class="m_logo">
            <a class="m_logo_a" href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a>
        </div>
